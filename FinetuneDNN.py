...
for i in range(len(layer)):
    for j in range(len(nodes)):
        ...
        DNN_no_window.FineTuneDNN_non_chord_tone(layer[i], nodes[j], 0, 1, 'DNN')
        ...
        DNN_no_window.FineTuneDNN_non_chord_tone(layer[i], nodes[j], 1, 1, 'DNN')
        DNN_no_window.FineTuneDNN_non_chord_tone(layer[i], nodes[j], 2, 1, 'DNN')
        DNN_no_window.FineTuneDNN_non_chord_tone(layer[i], nodes[j], 3, 1, 'DNN')
        DNN_no_window.FineTuneDNN_non_chord_tone(layer[i], nodes[j], 4, 1, 'DNN')
        DNN_no_window.FineTuneDNN_non_chord_tone(layer[i], nodes[j], 5, 1, 'DNN')
