...
1. Download and unzip the file from `https://github.com/juyaolongpaul/harmonic_analysis/releases/tag/v2.0`, then use `cd harmonic_analysis` to go into the project folder. Making sure that you are on the master branch.
